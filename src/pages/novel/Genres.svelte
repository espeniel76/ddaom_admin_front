			...
			<tr>
				...
				<td width="*">
					<div class="input-group">
						<input type="text" class="form-control form-control-sm" placeholder="장르" aria-label="Recipient's username with two button addons" bind:this={oSave.oGenre} />
		...
		<table class="table">
			<tbody class="table-border-bottom-0">
				<tr>
					...
					<td width="*">
						<div class="input-group">
							<input type="text" class="form-control form-control-sm" placeholder="장르" aria-label="Recipient's username with two button addons" bind:value={oSearch.Genre} />
					...
					<tr style="text-align:center" id={o.SeqGenre}>
						...
						<td>
							{#if oEdit.SeqGenre === o.SeqGenre}
								<input type="text" class="form-control" bind:this={oEdit.oGenre} value={o.Genre} style="text-align:center" placeholder="금칙어" />
							{:else}
								{o.Genre}
							{/if}
						</td>
						...
						<td>
							...
							{:else}
								<button type="button" class="btn btn-sm btn-info" on:click={handleChangeEditMode(o.SeqGenre)}>편집</button>
							{/if}
						</td>
					</tr>
				{/each}
