      ...
      <tbody class="table-border-bottom-0">
        <tr>
          ...
          <td width="200" style="vertical-align: middle;"
            >{Dates.getProcessText(o.StartDate, o.EndDate)}</td
          >
          <td width="100" style="text-align: right;"
            ><h5 class="mb-0">시작일</h5></td
          >
          <td width="200" style="vertical-align: middle;"
            >{Dates.defaultConvertFull(o.StartDate)}</td
          >
          <td width="100" style="text-align: right;"
            ><h5 class="mb-0">종료일</h5></td
          >
          <td width="*" style="vertical-align: middle;"
            >{Dates.defaultConvertFull(o.EndDate)}</td
          >
        </tr>
        <tr>
          <td width="100" style="text-align: right;"
        ...
        <tr>
          ...
          <td width="100" style="text-align: right;"
            ><h5 class="mb-0">등록일</h5></td
          >
          <td width="*" style="vertical-align: middle;"
            >{Dates.defaultConvertFull(o.CreatedAt)}</td
          >
        </tr>
        <tr>
          <td width="100" style="text-align: right;"
        ...
        <tr>
          ...
          >
          <td width="200" style="vertical-align: middle;"
            >{Dates.defaultConvertFull(o.UpdatedAt)}</td
          >
          <td width="100" style="text-align: right;"
            ><h5 class="mb-0">삭제유형</h5></td
          >
          <td width="*" style="vertical-align: middle;"
            >{Strings.getDeleteType(o.TypeDelete)}</td
          >
        </tr>
        <tr>
          <td width="100" style="text-align: right;"
            ><h5 class="mb-0">삭제사유</h5></td
          >
          <td width="*" style="vertical-align: middle;" colspan="5">
            <textarea class="form-control form-control-sm" rows="3"
              >{o.ReasonDelete}</textarea
            >
          </td>
        </tr>
      </tbody>
