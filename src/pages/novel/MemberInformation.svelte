			...
			<tbody class="table-border-bottom-0">
				<tr>
					...
					<td width="100" style="vertical-align: middle;text-align:center">
						<select class="form-select form-select-sm" id="exampleFormControlSelect1" aria-label="Default select example" bind:value={oSearch.oCategory}>
				...
				<tr>
					...
					<td width="*" colspan="4">
						<div class="input-group">
							<input type="text" class="form-control form-control-sm" placeholder="주제어" aria-label="Recipient's username with two button addons" bind:value={oSearch.Faq} />
		...
		<table class="table">
			<thead>
				...
				<tr style="text-align:center">
					<th width="50"><input class="form-check-input" type="checkbox" id="defaultCheck3" bind:group={$checkedList} on:click={checkedAllchange} /></th>
					<th width="50">No</th>
					<th width="50">카테고리</th>
					<th width="*">제목</th>
			...
			<tbody class="table-border-bottom-0">
				{#each $faq.Data.List as o, index}
					<tr style="text-align:center" id={o.SeqFaq}>
						<td><input class="form-check-input" type="checkbox" id="defaultCheck3" bind:group={$checkedList} value={o.SeqFaq} checked={$check} /></td>
						<td>{o.SeqFaq}</td>
						<!-- <td>{o.faqCategory}</td> -->
