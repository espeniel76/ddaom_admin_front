...
function setMemberInformation() {
	...
	const editMemberInformation = async (SeqMember, isBlocked, BlockedReason, StartDate, EndDate) => {
		try {
	...
	const saveMemberInformation = async (SeqMember, isBlocked, BlockedReason, StartDate, EndDate) => {
		try {
